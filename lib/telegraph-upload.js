...
// const getGroupName = require('./get-group-name')
module.exports = async (chapter, manga, images, botUsername) => {
    ...
    [
      {
        tag: 'h1',
        children: [
          `${mangaTitle} ${chapter.volume ? `Vol. ${chapter.volume} ` : ''}Ch. ${chapter.chapter}`
        ]
      }, {
        tag: 'br'
      }, {
